...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen gradient-hero paw-pattern overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-card rounded-2xl shadow-medium p-4 border border-border">
              <div className="flex flex-col md:flex-row gap-3">
                <div className="flex-1 relative">
                  ...
                  <input type="text" placeholder="Enter your location" value={location} onChange={e => setLocation(e.target.value)} className="w-full h-12 pl-10 pr-4 rounded-xl bg-muted/50 border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" />
                </div>
                <div className="flex-1">
                  <select value={service} onChange={e => setService(e.target.value)} className="w-full h-12 px-4 rounded-xl bg-muted/50 border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer">
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 animate-float">
              <img src="https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600&h=700&fit=crop" alt="Happy dog with owner" className="w-full max-w-lg mx-auto rounded-3xl shadow-2xl object-cover" />
